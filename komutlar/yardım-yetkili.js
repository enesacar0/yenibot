...
exports.run = (client, message, args) => {
    ...
    .setAuthor(` | Yetkili Komutları`, client.user.avatarURL) 
      .setDescription('**[destek sunucum için tıkla](https://discord.gg/jyPzXRV)**')
.setThumbnail(client.user.avatarURL)
      ...
      .addField('**Diğer**', '`sunucukurulum`, `herkesten-rol-al`, `herkese-rol-ver`, `unbanall`, `serverpanel`, `serverpanelkaldır`')
